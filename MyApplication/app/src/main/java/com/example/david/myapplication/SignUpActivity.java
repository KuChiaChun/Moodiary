                                    ...
                                    user.sendEmailVerification()
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        Toast.makeText(SignUpActivity.this, "Email 驗證成功", Toast.LENGTH_SHORT).show();
                                                    } else{
                                                        Toast.makeText(SignUpActivity.this, "Email 驗證"+task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            });
