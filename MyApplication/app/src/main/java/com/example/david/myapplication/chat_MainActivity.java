...
public class chat_MainActivity extends BaseActivity {
                    ...
                    protected void populateViewHolder(UserViewHolder viewHolder, final User user, int position) {
                        ...
                        if (user.getPhotoUrl() == null) {
                            viewHolder.thumbImageView.setImageDrawable(
                                    ContextCompat.getDrawable(chat_MainActivity.this, R.drawable.ic_account_circle_black_36dp));
                        } else {
                            Glide.with(chat_MainActivity.this)
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(chat_MainActivity.this, "Authentication failed.", Toast.LENGTH_SHORT).show();
                        } else {
                            setupView();
                        }
                    }
    ...
    private void openChatRoom(String roomId) {
        Intent openChatroomForUser = new Intent(chat_MainActivity.this, ChatRoomActivity.class)
